        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('dashboard') }}" class="b-brand text-primary">
                    <img src="{{ asset('images/VasaHotel.png') }}" alt="Logo" class="logo-header"
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('daily-reports.index') }}" class="pc-link">
                            ...
                            <span class="pc-mtext">Restaurants</span>
                        </a>
                    </li>
                    {{-- <li class="pc-item">
                        <a href="#" class="pc-link">
                    ...
                    @hasrole('Super Admin')
                        ...
                        <li class="pc-item">
                            <a href="{{ route('restaurants.index') }}" class="pc-link">

...
<html>
<head>
    <title>Bulk Daily Report PDF</title>
    <style>
        ...
        .section-title { background-color: #eee; padding: 5px; font-weight: bold; font-size: 11px; margin-top: 15px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; }
        .data-table { width: 100%; border-collapse: collapse; margin-top: 5px; }
        .data-table th, .data-table td { border: 1px solid #ddd; padding: 5px; text-align: left; }
        .data-table th { background-color: #f9f9f9; }
        .text-end { text-align: right; }
        .text-center { text-align: center; }
        .badges { margin-top: 2px; }
        .badge { display: inline-block; padding: 2px 5px; background: #f0f0f0; border: 1px solid #ccc; border-radius: 3px; font-size: 9px; margin-right: 2px; }
        .footer { margin-top: 40px; text-align: right; font-size: 9px; color: #888; }
        .signature-box { margin-top: 30px; width: 100%; }
        .sig-col { width: 33%; float: left; text-align: center; }
        .sig-line { margin-top: 50px; border-top: 1px solid #333; width: 80%; margin-left: auto; margin-right: auto; }
